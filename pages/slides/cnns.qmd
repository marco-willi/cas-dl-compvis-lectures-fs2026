---
title: "3 - Convolutional Neural Networks"
params:
...
![ ]({{< meta params.images_path >}}mlp_images_example_weights.png){fig-align="center"}
...
![]({{< meta params.images_path >}}mlp_images_example_pattern_shifts.png){fig-align="center"}

::: {.fragment}
Patterns or objects often occur at different positions -> need to recognize them everywhere!
:::
...
![]({{< meta params.images_path >}}mlp_images_examples_permutation.png){fig-align="center"}

::: {.fragment}
**Question**: Can an MLP successfully learn patterns in images $\vect{x}$ that are permuted with a fixed permutation matrix $\m{P}$, i.e. $f(P(\vect{x}))$?
:::


## MLPs and Images: Often Not the Best Choice
...
::: {#fig-cnns-invariance-example layout-ncol=2 fig-width=6}

![Original]({{< meta params.images_path >}}cows2_invariance_original.png){width=75%}

![Translated]({{< meta params.images_path >}}cows2_invariance_translate.png){width=75%}

![Color-jittered]({{< meta params.images_path >}}cows2_invariance_color.png){width=75%}

![Rotated]({{< meta params.images_path >}}cows2_invariance_rotate.png){width=75%}
...
::: {#fig-cnns-equivariance-example layout-ncol=2 fig-width=6}

![Original]({{< meta params.images_path >}}cows2_equivariance_original.png){width=75%}

![Shifted right]({{< meta params.images_path >}}cows2_equivariance_shift_right.png){width=75%}

![Shifted left]({{< meta params.images_path >}}cows2_equivariance_shift_left.png){width=75%}

![Shifted up + right]({{< meta params.images_path >}}cows2_equivariance_shift_up.png){width=75%}
...
::: {.fragment}
\begin{equation}
S(i, j) = (K * I)(i, j) = \sum_m \sum_n I(i + m, j + n) K(m, n) + b
\end{equation}
