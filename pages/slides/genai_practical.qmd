...
$$\vect{x}_T \sim \mathcal{N}(\mathbf{0}, \mathbf{I}) \rightarrow \vect{x}_{T-1} \rightarrow \cdots \rightarrow \vect{x}_0$$
:::
...
- Image generation is **integrated** into multimodal assistants
